  ...
  <div repo-modal>
    <div class="panel">
      ...
      <template v-else>
        ...
        <label><span>Git URL(SSH)</span><input type="text" v-model="model.sshUrl" title="Git URL" data-validate="((?!http).)+" data-invalid="SSH 경로인지 확인해주세요"></label>
      ...
      <div class="btn-holder" v-if="edit">
        <template v-if="!publicKey">
          <button @click="toPublic">공개키 확인</button>
